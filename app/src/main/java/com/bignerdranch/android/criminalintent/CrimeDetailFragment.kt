...
class CrimeDetailFragment : Fragment() {
    ...
    private fun updateUi(crime: Crime) {
        binding.apply {
            ...
            crimePhoto.setOnClickListener {
                val dialog = DetailImageFragment().apply {
                    arguments = bundleOf("photoFileName" to crime.photoFileName)
                }
                dialog.show(parentFragmentManager, "DetailImage")
            }
            ...
            crimeReport.setOnClickListener {
                ...
                // startActivity(reportIntent) code for without chooser
    ...
    private fun getCrimeReport(crime: Crime): String {
        ...
        return getString(
            ...
            dateString, solvedString, suspectText)
    }
